    ...
    <>
      <div className="container mx-auto  md:flex justify-end space-x-[10px] xl:pr-[50px] pr-[10px] pt-[120px] hidden">
        <ImgLink
          ...
          target="_blank"
        />
        <ImgLink img={DiscordImg} path="https://discord.gg/cGJYpC7QnQ" target="_blank" width={75} height={55} />
        <ImgLink
          className="mt-[10px]"
          img={InstagramImg}
          width={38}
          ...
          <div className="md:flex md:space-x-[50px] mt-[-50px]">
            ...
            <div className="basis-1/2 mt-[50px]">
              <div className="modal-wrapper">
                <h4 className="modal-title 2xl:text-[24px] lg:text-[18px] text-white">Pre-Sale Minting TBD</h4>
                <p className="2xl:text-[18px] md:text-[15px] text-[14px] text-white">
                  Join our immersive community and be a part of the Long Horn Mansion Club. The LMC Team is hard at work, delivering, tailoring, and executing the pre-roadmap actions to maximize security of smart contract, preparation of community, locked partnerships, and more...
                </p>
                <CountDown />
                <DaoIconButton
